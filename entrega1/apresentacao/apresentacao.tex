...
\input{../tabelas/numeros_verificacao.tex}
\input{../tabelas/ambiente_hardware.tex}
\newcommand{\Wq}{W_q}
...
\setbeamertemplate{footline}{%
  \leavevmode\hbox{\begin{beamercolorbox}[wd=\paperwidth,ht=2.5ex,dp=1ex,leftskip=1.2em,rightskip=1.2em]{footline}%
    \usebeamerfont{footline}\scriptsize Sanchez Morales, G. A.\hfill Experimento fatorial em filas simuladas\hfill \insertframenumber{} / \inserttotalframenumber
  \end{beamercolorbox}}}
...
\author{Gruner Antonio Sanchez Morales}
...
\begin{frame}[plain]
  ...
  \vspace{0.9cm}
  {\large Gruner Antonio Sanchez Morales\par}
  \vspace{4pt}
...
\begin{frame}{Projeto fatorial $2^3 r$: as 8 combinações}
  \begin{columns}[T]
    \begin{column}{0.58\textwidth}
      ...
      \resizebox{\textwidth}{!}{\input{../tabelas/tab_delineamento.tex}}
...
\begin{frame}{Ambiente computacional e reprodutibilidade}
  \begin{columns}[T]
    \begin{column}{0.36\textwidth}
      ...
      \footnotesize
      \input{../tabelas/tab_ambiente_software.tex}
...
\begin{frame}{Viabilidade e decisões de projeto}
  ...
  \resizebox{0.86\textwidth}{!}{\input{../tabelas/tab_comprimento_corrida.tex}}
